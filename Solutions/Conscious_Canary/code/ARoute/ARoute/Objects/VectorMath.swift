...
extension SCNNode {
    private struct UniqueIdProperties {
        static var uniqueId:String? = nil
        //static var storedMaterial:SCNMaterial = SCNMaterial()
    }
    public var uniqueId : String? {
        get
        {
            return UniqueIdProperties.uniqueId
        }
        
        set
        {
            UniqueIdProperties.uniqueId = newValue
        }
    }
    /*public var storedMaterial : SCNMaterial {
        get
        {
            return UniqueIdProperties.storedMaterial
        }
        
        set
        {
            UniqueIdProperties.storedMaterial = newValue
        }
    }*/
}
...
/*
extension SCNCamera {
    class func getForwardVector() -> (SCNVector3, SCNVector3) { // (direction, position)
        
            let mat = SCNMatrix4(self.transform) // 4x4 transform matrix describing camera in world space
